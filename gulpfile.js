...
const banner = ['/*!\n',
  ...
  ' * Licensed under <%= pkg.license %> (https://github.com/Sesi0/<%= pkg.name %>/blob/master/LICENSE)\n',
  ' */\n',
  '\n'
].join('');
...
function modules() {
  ...
  // Localize
  var localize = gulp.src('./node_modules/jquery-localize/dist/*')
  .pipe(gulp.dest('./vendor/jquery-localize'));
  // jQuery
  var jquery = gulp.src([
